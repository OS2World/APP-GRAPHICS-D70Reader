...
/* $Header: //xaptk/expat/xmltok/xmltok.h#3 $ */
/*
...
int XMLTOKAPI SYMUNGE(XmlParseXmlDecl)(int isGeneralTextEntity,
                  const ENCODING *enc,
                  const char *ptr,
                  const char *end,
                  const char **badPtr,
...
int XMLTOKAPI SYMUNGE(XmlInitEncoding)(INIT_ENCODING *, const ENCODING **, const char *name);
const ENCODING XMLTOKAPI * SYMUNGE(XmlGetUtf8InternalEncoding)();
const ENCODING XMLTOKAPI * SYMUNGE(XmlGetUtf16InternalEncoding)();
int XMLTOKAPI SYMUNGE(XmlUtf8Encode)(int charNumber, char *buf);
int XMLTOKAPI SYMUNGE(XmlUtf16Encode)(int charNumber, unsigned short *buf);

int XMLTOKAPI SYMUNGE(XmlSizeOfUnknownEncoding)();
ENCODING XMLTOKAPI *
