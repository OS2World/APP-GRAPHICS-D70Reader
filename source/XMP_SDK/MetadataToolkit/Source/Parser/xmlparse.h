...
/* $Header: //xaptk/expat/xmlparse/xmlparse.h#3 $ */
/*
...
SYMUNGE(XML_ParserCreate)(const XML_Char *encoding);
...
void XMLPARSEAPI
SYMUNGE(XML_SetElementHandler)(XML_Parser parser,
              XML_StartElementHandler start,
              XML_EndElementHandler end);

void XMLPARSEAPI
SYMUNGE(XML_SetCharacterDataHandler)(XML_Parser parser,
                XML_CharacterDataHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetProcessingInstructionHandler)(XML_Parser parser,
                    XML_ProcessingInstructionHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetDefaultHandler)(XML_Parser parser,
              XML_DefaultHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetUnparsedEntityDeclHandler)(XML_Parser parser,
                 XML_UnparsedEntityDeclHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetNotationDeclHandler)(XML_Parser parser,
               XML_NotationDeclHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetExternalEntityRefHandler)(XML_Parser parser,
                XML_ExternalEntityRefHandler handler);

void XMLPARSEAPI
SYMUNGE(XML_SetUnknownEncodingHandler)(XML_Parser parser,
...
void XMLPARSEAPI
SYMUNGE(XML_SetUserData)(XML_Parser parser, void *userData);
...
void XMLPARSEAPI
SYMUNGE(XML_UseParserAsHandlerArg)(XML_Parser parser);
...
int XMLPARSEAPI
SYMUNGE(XML_SetBase)(XML_Parser parser, const XML_Char *base);

const XML_Char XMLPARSEAPI *
SYMUNGE(XML_GetBase)(XML_Parser parser);
...
void XMLPARSEAPI *
SYMUNGE(XML_GetBuffer)(XML_Parser parser, int len);

int XMLPARSEAPI
SYMUNGE(XML_ParseBuffer)(XML_Parser parser, int len, int isFinal);
...
XML_Parser XMLPARSEAPI
SYMUNGE(XML_ExternalEntityParserCreate)(XML_Parser parser,
                   const XML_Char *openEntityNames,
...
enum XML_Error XMLPARSEAPI SYMUNGE(XML_GetErrorCode)(XML_Parser parser);
...
int XMLPARSEAPI SYMUNGE(XML_GetCurrentLineNumber)(XML_Parser parser);
int XMLPARSEAPI SYMUNGE(XML_GetCurrentColumnNumber)(XML_Parser parser);
long XMLPARSEAPI SYMUNGE(XML_GetCurrentByteIndex)(XML_Parser parser);

/* For backwards compatibility with previous versions. */
#define XML_GetErrorLineNumber SYMUNGE(XML_GetCurrentLineNumber)
#define XML_GetErrorColumnNumber SYMUNGE(XML_GetCurrentColumnNumber)
#define XML_GetErrorByteIndex SYMUNGE(XML_GetCurrentByteIndex)

/* Frees memory used by the parser. */
void XMLPARSEAPI
SYMUNGE(XML_ParserFree)(XML_Parser parser);

/* Returns a string describing the error. */
const XML_LChar XMLPARSEAPI *SYMUNGE(XML_ErrorString)(int code);
